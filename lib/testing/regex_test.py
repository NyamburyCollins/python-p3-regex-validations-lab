...
class TestNameRegEx:
    ...
    def test_matches_john_cena(self):
        ...
        assert name_regex.fullmatch("John Cena") is not None

    def test_matches_anya_taylor_joy(self):
        '''matches the string "Anya Taylor-Joy".'''
        assert not name_regex.fullmatch("Anya Taylor-Joy")

    def test_matches_dangelo(self):
        '''matches the string "D'Angelo".'''
        assert not name_regex.fullmatch("D'Angelo") 
...
class TestPhoneRegEx:
    ...
    def test_matches_format_nnnnnnnnnn(self):
        ...
        assert not phone_regex.fullmatch("5555555555")
...
class TestEmailRegEx:
    ...
    def test_matches_name_email(self):
        ...
        assert not email_regex.fullmatch("johncena@wwe.com")
    ...
    def test_matches_dot_name_number_email(self):
        ...
        assert not email_regex.fullmatch("john.cena123@wwe.com")
